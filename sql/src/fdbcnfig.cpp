...
//
// $Id: fdbcnfig.cpp 3112 2006-01-19 13:12:40 -0700 (Thu, 19 Jan 2006) dsanders $
//------------------------------------------------------------------------------
	...
	FLMBOOL	bKeepFiles)
{
	...
	{
		if (RC_BAD( rc = dbLock( SFLM_LOCK_EXCLUSIVE, 0,
									SFLM_NO_TIMEOUT)))
		{
			goto Exit;
		}
	...
	if (RC_BAD( rc = doCheckpoint( SFLM_NO_TIMEOUT)))
	{
		goto Exit;
	}
