//------------------------------------------------------------------------------
// Desc:	FLAIM's dynamic, interactive list manager
//
// Tabs:	3
//
...
//
// $Id: flm_dlst.h 3117 2006-01-19 13:34:36 -0700 (Thu, 19 Jan 2006) dsanders $
//------------------------------------------------------------------------------
...
#ifdef FLM_NLM
	#define DLIST_DUMPFILE_PATH (FLMBYTE*)"sys:/system/dlstdump.txt"
#else
	#define DLIST_DUMPFILE_PATH (FLMBYTE*)"dlstdump.txt"
#endif
